...
3. Create an [ngrok account](https://ngrok.com/) and set up the [authtoken](https://dashboard.ngrok.com/get-started/your-authtoken) in order to enable port-forwarding.
...
To start local development, run the below shell command

```shell
npm run dev
```

Open the URL generated in your console. On your first time, it'll authenticate your shopify account. Then, it'll let you select a development store to depoy the app to. Afterwards, a URL will be generated, which allows you to register your development app to the store.

## Shopify stuff below (not Randy written)
